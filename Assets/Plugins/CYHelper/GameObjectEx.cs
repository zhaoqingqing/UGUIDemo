...
public static class GameObjectEx
{
	...
	public static T AddCompIfNull<T>(this GameObject pObj) where T : Component
    {
    ...
    public static GameObject FindChildX(this GameObject pTran, string name, bool includeInactive = true)
    {
